...
CON.witch_skill_prompt_v3 = """Please combine the role settings, objective information, and subjective information (objective information is always true, while subjective information contains deceptive content) to analyze potential alliances and players' identities. Decide whether to use your healing potion and poison potion: 
...
Please output in JSON format using the keywords "Identity to Present", "Identity Labels", "Vote" and "Speech".
"""
...
Please analyze the current situation and output your decision in JSON format using the keywords "notes", "voting reason" and "voting player".
...
{subjective_info}
You are currently {your_role}. 
Please analyze the current situation based on the role setting,  objective information, and subjective information, and form your notes for this round (note that  objective information is definitely true, while subjective information may contain deceptive  statements). Summarize and analyze the night information and player statements, and output  the reason for voting and the player to be voted out, directly output the player number;  if abstaining, please output "abstain". Please output in JSON format using the keywords "notes",  "voting reason" and "voting player".
"""
